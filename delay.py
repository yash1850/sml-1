...
def loadData():
    ...
    sample_size = min(10000, dataset_length)  # Ensure sample size doesn't exceed dataset length
    
    # Sample the data
    final_data = data.sample(n=sample_size, replace=(sample_size > dataset_length))
